...
export default function Home() {
    return (
        <div
            ...
            bg-[url('/homeMobile.png')] 
    sm:bg-[url('/pageBG.png')]"
        // style={{ backgroundImage: "url('/pageBG.png')" }}
        >
            <div className='hidden sm:block'>
                <div className='flex flex-col sm:flex-row justify-start w-full sm:max-h-screen 2xl:min-h-screen sm:w-full 2xl:w-[70%] max-w-7xl sm:mx-5 2xl:mx-auto'>
            ...
            <div className='block sm:hidden  py-8 h-screen'>
                <div className="flex flex-col justify-between mx-10 h-full">
                    <div className='flex flex-row justify-between items-center w-full'>
                        <BiMenu className='h-10 w-10 text-black' />
                    ...
                    <div className='flex flex-col justify-end mb-10 gap-4 h-full'>
                        <div
                            className="flex flex-col justify-between items-center rounded-xl p-6 pb-0 h-fit w-full mt-10"
                            style={{
                                background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 2',
                        ...
                        >
                            <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-[#282463] to-[#007DFC] font-medium text-2xl text-center">
                                Organization and Productivity
                            </h2>
                            <Image
                                src={"/iconGroup.png"}
                        ...
                        <div className='flex flex-row gap-4'>
                            <div
                                className="flex flex-col justify-between items-start rounded-xl p-4 h-full w-1/2"
                                style={{
                                    background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                    borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 2',
                            ...
                            >
                                <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-[#282463] to-[#007DFC] font-medium text-lg">
                                    Study Assistance
                                </h2>
                            </div>
                            <div
                                className="flex flex-col justify-center items-start rounded-xl p-2 w-1/2"
                                style={{
                                    background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                    borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 2',
                        ...
                        <div className='flex flex-row gap-4'>
                            <div
                                className="flex flex-col justify-between items-start rounded-xl p-4 pr-0 h-full w-1/2"
                                style={{
                                    background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                    borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 2',
                            ...
                            <div
                                className="flex flex-col justify-center items-start rounded-xl p-4 w-1/2"
                                style={{
                                    background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                    borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 2',
                 ...
                 rgba(255, 255, 255, 0.6)`,
                    ...
                    <div
                        className="flex flex-row justify-between items-center rounded-xl p-3 px-6 w-full mb-10"
                        style={{
                            background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                            borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 2',
                    ...
                    >
                        <input
                            ...
                            className="text-[13px] font-medium text-gray-600 w-full focus:outline-none focus:ring-0 focus:border-none"
                        />

                        <div className='flex flex-row gap-4 items-center'>
                            <BsPaperclip className='h-5 w-5 text-gray-400' />
                            <div className='h-7 w-7 bg-blue-600 rounded-full p-2'>
                                <IoMdArrowRoundUp className='h-3 w-3 text-white' />
