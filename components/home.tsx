        ...
        <>
            ...
            <div className='block sm:hidden'>
                <div className='flex flex-col gap-4 mt-10'>
                    <div
                        className="flex flex-col items-center justify-end rounded-xl h-[360px] w-full"
                        style={{
                            background: `linear-gradient(to right, rgba(255, 255, 255, 0.4) 0%, rgba(255, 255, 255, 0.25) 100%),rgba(255, 255, 255, 0)`,
                            borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
                        }}
                 ...
                 rgba(255, 255, 255, 0.6)`,
                    ...
                    <div
                        className="flex flex-col justify-between rounded-xl p-6 h-[470px] w-full"
                        style={{
                            background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                            borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
                    ...
                    <div className='flex flex-row gap-3'>
                        <div
                            className="flex flex-col justify-between rounded-xl  p-3  w-1/2"
                            style={{
                                background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
                        ...
                        >
                            ...
                            <p
                                className="text-transparent bg-clip-text font-semibold text-lg h-20"
                                style={{
                                    backgroundImage: 'linear-gradient(to bottom, #0064FE 0%, #FFFFFF 100%)'
                                }}
                            ...
                            <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-[#282463] to-[#007DFC] font-bold text-[18px] max-w-56 ">
                                {"Social Media & Basic Coding".toUpperCase()}
                            </h2>

                        </div>
                        <div
                            className="flex flex-col justify-between rounded-xl  p-3 h-44 w-1/2"
                            style={{
                                background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                                borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
                        ...
                        >
                            ...
                            <div className='flex flex-row justify-between items-center'>
                                <p
                                    className="text-transparent bg-clip-text font-semibold text-md h-22 w-32"
                                    style={{
                                        backgroundImage: 'linear-gradient(to bottom, #0064FE 0%, #FFFFFF 100%)'
                                    }}
                    ...
                    <div
                        className="flex flex-col items-center justify-between rounded-xl h-[500px] w-full"
                        style={{
                            background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),rgba(255, 255, 255, 0.6)`,
                            borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
                        }}
                    >
                        ...
                        <Image
                            ...
                            priority
                        />
                        <div className="bg-white rounded-xl py-4 px-2 shadow-sm m-6">
                            <p className='text-transparent bg-clip-text bg-gradient-to-r from-[#95A4FC] to-[#1C1C1C] font-bold text-sm text-center'>
                                Can you help me understand Newton’s laws?
                            </p>
                        </div>
                    ...
                    <div
                        className="flex flex-col justify-between items-center rounded-xl w-full"
                        style={{
                            background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                            borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
                    ...
                    >
                        <div className='flex flex-col items-center gap-3 p-6 '>
                            <div className='flex flex-col items-center'>
                                <p
                                    className="text-transparent bg-clip-text font-semibold text-md h-10"
                                    style={{
                                        backgroundImage: 'linear-gradient(to bottom, #0064FE 0%, #FFFFFF 100%)'
                                    }}
                            ...
                            <p className='text-[#757575]/50 font-bold text-md w-60 text-center'>
                                How do I balance studying
                                and soccer practice?
                            </p>
                        </div>
                    ...
                    <div
                        className="flex flex-col justify-between items-center rounded-xl  h-full w-full"
                        style={{
                            background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 100%),
                 rgba(255, 255, 255, 0.6)`,
                            borderImage: 'linear-gradient(to bottom right, rgba(255, 255, 255, 0.6), rgba(255, 255, 255, 0)) 1',
